...
router.put(
  ...
  [
    ...
    /*  check('CODSERVICIO', 'El CODSERVICIO es obligatorio').not().isEmpty(), */
    /*    check('CODPROCEDENCIA', 'El CODPROCEDENCIA es obligatorio').not().isEmpty(), */
    check("CODDOCTOR", "El CODDOCTOR es obligatorio").not().isEmpty(),
    /*  check('TIPOIDENTIFICADOR', 'El TIPOIDENTIFICADOR es obligatorio')
       .not()
       .isEmpty(), */
...
router.post(
  ...
  [
    ...
    /* check('CODSALA', 'El SALA es obligatorio').not().isEmpty(), */

    /* check('CODPROVINCIA', 'El CODPROVINCIA es obligatorio').not().isEmpty(), */
    /*   check('DIRECCION', 'El DIRECCION es obligatorio').not().isEmpty(), */

    /* check('TIPOIDENTIFICADOR', 'El TIPOIDENTIFICADOR es obligatorio').not().isEmpty(), */
    check("IDENTIFICADOR", "El IDENTIFICADOR es obligatorio").not().isEmpty(),
    check("NOMBRES", "El NOMBRES es obligatorio").not().isEmpty(),
    check("APELLIDO", "El APELLIDO es obligatorio").not().isEmpty(),
    // check("SEGUNDOAPELLIDO", "El SEGUNDOAPELLIDO es obligatorio").not().isEmpty(),
    check("FECHANACIMIENTO", "El FECHANACIMIENTO es obligatorio")
      .not()
      .isEmpty(),
    check("SEXO", "El SEXO es obligatorio").not().isEmpty(),
